...
interface DataTableProps {
  ...
  setSelectedRow: any
  selectedRow: any
  createConversion:any,
  updateConversion:any
}

const DataTable: React.FC<DataTableProps> = ({setSelectedRow, selectedRow}) => {
  ...
  const columns = ConversionColumn( theme, selectedRow,setSelectedRow)
  const rows: any[] = []
  return (
    <>
      {isLoading ? (
        ...
        <div className="table">
          <DataGrid
            ...
            rowCount={0} // Ensure the total count is passed correctly
