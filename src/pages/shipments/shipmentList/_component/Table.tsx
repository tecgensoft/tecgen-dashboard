...
import { useGetShipmentsListQuery } from '../../../../redux/feature/shipment/shipmentApi'
...
const DataTable: React.FC<DataTableProps> = ({
  ...
  const { data, isLoading } = useGetShipmentsListQuery({
    search: text,
    page: paginationModel.page + 1,
  })

  const columns: GridColDef[] = ShipmentColumns(
    theme,
    setIsOpen,
    setSelectedRow,
    selectedRow,
