...
import { useGetLocationListQuery } from '../../../../redux/feature/product/ProductApi'
import ProductColumn from './LocationColumn'
...
const DataTable: React.FC<DataTableProps> = ({
  ...
  const { data, isLoading } = useGetLocationListQuery({
    search: text,
    page: paginationModel.page + 1,
  })
  // console.log('DATA', data)
  const columns: GridColDef[] = ProductColumn(
    theme,
    setIsOpen,
    setSelectedRow,
    selectedRow,
