...
import { useGetOfficeExpenseApiListQuery } from '../../../../redux/feature/officeExpense/officeExpenseApi'
import OfficeExpenseColumn from './OfficeExpenseColumn'
...
const DataTable: React.FC<DataTableProps> = ({
  ...
  const { data, isLoading } = useGetOfficeExpenseApiListQuery({
    search: text,
    page: paginationModel.page + 1,
  })

  const columns: GridColDef[] = OfficeExpenseColumn(
    theme,
    setCreateOpenModal,
    setSelectedRow,
    selectedRow,
