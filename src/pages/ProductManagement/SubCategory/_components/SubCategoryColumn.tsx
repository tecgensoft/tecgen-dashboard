...
import { useDeleteSubCategoryMutation } from '../../../../redux/feature/productManagement/productManagementApi'

export default function SubCategoryColumn(handleEdit: { (editValue: any): void; (arg0: any): void }) {
...
const handleView = (row: { id: SetStateAction<null> }) => {
  ...
  const handleDelete = async (deleteValue: string|null) => {
    if(deleteValue){      
      try {
        await deleteSubCategory({id: deleteValue}).then((res) => {
